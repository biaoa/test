...
$(document).ready(function() {
	...
	$(".main_click4").click(function(){	  
	 ...
	 $.ajax({  
         url : basepath+'/sys/getAllCommunityList',
         type : 'POST',
         dataType : 'json',
...
function LoadSerie_Ajax(oOptions) { 
        ...
        oChart.showLoading(); 
        $.ajax({  
            url : basepath+'/sys/getRegisterCountByCharts',
            type : 'POST',
            dataType : 'json',
            success : function(data){
...
function LoadSerie_Ajax2(oOptions2,timeRule,communityId) {
       ...
       oChart2.showLoading(); 
       $.ajax({  
           url : basepath+'/sys/getActiveUserStatisticss',
           type : 'POST',
           dataType : 'json',
...
function LoadSerie_Ajax3(oOptions3,timeRule) {
	...
	oChart3.showLoading(); 
    $.ajax({  
        url : basepath+'/sys/getSalesStatisticss',
        type : 'POST',
        dataType : 'json',
...
function LoadSerie_Ajax4(oOptions4,timeRule) {
	...
	oChart4.showLoading(); 
	 $.ajax({  
	     url : basepath+'/sys/getOrdersStatisticss',
	     type : 'POST',
	     dataType : 'json',
	     data:{'timeRule':timeRule},//sevenDay thirtyDay thisYear
	     success : function(data){
...
function LoadSerie_Ajax5(oOptions5,timeRule) {
	...
	oChart5.showLoading(); 
	 $.ajax({  
	     url : basepath+'/sys/getOrderStatisticsByPie',
	     type : 'POST',
	     dataType : 'json',
	     data:{'timeRule':timeRule},//sevenDay thirtyDay thisYear
	     success : function(data){
...
function LoadSerie_Ajax6(oOptions6,timeRule,communityId) {
	   ...
	   oChart6.showLoading(); 
       $.ajax({  
           url : basepath+'/sys/getRegisterUserStatisticss',
           type : 'POST',
           dataType : 'json',
           data:{'timeRule':timeRule,'communityId':communityId},//sevenDay thirtyDay thisYear
           success : function(data){
