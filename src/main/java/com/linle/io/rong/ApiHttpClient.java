package com.linle.io.rong;

import com.linle.io.rong.models.ChatroomInfo;
import com.linle.io.rong.models.FormatType;
import com.linle.io.rong.models.GroupInfo;
import com.linle.io.rong.models.Message;
import com.linle.io.rong.models.SdkHttpResult;
import com.linle.io.rong.util.HttpUtil;
import com.linle.io.rong.models.*;
...
public class ApiHttpClient {
	 ...
	 * @param appSecret
	 * @param userId 用户 Id，
	 * @param userName 用户名称 用来在 Push 推送时显示用户的名称
	 * @param portraitUri 用户头像 URI，用来在 Push 推送时显示用户的头像
	 * @param format
	 * @return code,token,userId
	 * @throws Exception
	 */
	 ...
	 * @param userId 用户 Id
	 * @param format
	 * @return code,status(在线状态，1为在线，0为不在线)
	 * @throws Exception
	 */
	 ...
	 * @param appKey
	 * @param appSecret
	 * @param userId  加入群的用户 Id
	 * @param groupId 群组 Id
	 * @param groupName 群组 Id 对应的名称
	 * @param format
	 * @return code
	 * @throws Exception
	 */
