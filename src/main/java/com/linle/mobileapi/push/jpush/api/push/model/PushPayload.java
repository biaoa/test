package com.linle.mobileapi.push.jpush.api.push.model;
...
import com.linle.mobileapi.push.jpush.api.push.model.notification.PlatformNotificationjpush;
...
public class PushPayload implements PushModel {
    ...
    private final Messagejpush message;
    private Options options;
    
    
    private PushPayload(Platform platform, Audience audience, 
            Notification notification, Messagejpush message, Options options) {
    ...
    public static PushPayload messageAll(String msgContent) {
        return new Builder()
            .setPlatform(Platform.all())
            .setAudience(Audience.all())
            .setMessage(Messagejpush.content(msgContent)).build();
    }
    ...
    public boolean isIosExceedLength() {
        ...
        if (payload.has(NOTIFICATION)) {
            ...
            if (notification.has(IosNotification.NOTIFICATION_IOS)) {
                ...
                if (notification.has(PlatformNotificationjpush.ALERT)) {
                    String alert = notification.get(PlatformNotificationjpush.ALERT).getAsString();
    ...
    public static class Builder {
        ...
        private Messagejpush message = null;
        ...
        public Builder setMessage(Messagejpush message) {
            this.message = message;
            return this;
        }
