...
public class Messagejpush implements PushModel {    
    ...
    private Messagejpush(String title, String msgContent, String contentType, 
    ...
    public static Messagejpush content(String msgContent) {
    ...
    public static class Builder {
        ...
        public Messagejpush build() {
            Preconditions.checkArgument(! (null == msgContent), 
                    "msgContent should be set");
            return new Messagejpush(title, msgContent, contentType, 
