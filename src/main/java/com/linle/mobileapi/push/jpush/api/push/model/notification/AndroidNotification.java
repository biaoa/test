...
public class AndroidNotification extends PlatformNotificationjpush {
    ...
    public static class Builder extends PlatformNotificationjpush.Builder<AndroidNotification, Builder> {
