...
public abstract class PlatformNotificationjpush implements PushModel {
    public static final String ALERT = "alert";
    private static final String EXTRAS = "extras";
    
    protected static final Logger LOG = LoggerFactory.getLogger(PlatformNotificationjpush.class);
    ...
    public PlatformNotificationjpush(Object alert, Map<String, String> extras,
    ...
    protected abstract static class Builder<T extends PlatformNotificationjpush, B extends Builder<T, B>> {
