package com.linle.mobileapi.push.jpush.api.push.model.notification;

import com.linle.mobileapi.push.jpush.api.push.model.PushModel;
...
public class Notification implements PushModel {    
    ...
    private final Set<PlatformNotificationjpush> notifications;
    
    private Notification(Object alert, Set<PlatformNotificationjpush> notifications) {
        this.alert = alert;
    ...
    public JsonElement toJSON() {
        ...
        if (null != alert) {
            if(alert instanceof JsonObject) {
                json.add(PlatformNotificationjpush.ALERT, (JsonObject) alert);
            } else if (alert instanceof IosAlert) {
                json.add(PlatformNotificationjpush.ALERT, ((IosAlert) alert).toJSON());
            } else {
                json.add(PlatformNotificationjpush.ALERT, new JsonPrimitive(alert.toString()));
            }
        }
        if (null != notifications) {
            for (PlatformNotificationjpush pn : notifications) {
    ...
    public static class Builder {
        ...
        private Set<PlatformNotificationjpush> builder;
        ...
        public Builder addPlatformNotification(PlatformNotificationjpush notification) {
            if (null == builder) {
                builder = new HashSet<PlatformNotificationjpush>();
            }
