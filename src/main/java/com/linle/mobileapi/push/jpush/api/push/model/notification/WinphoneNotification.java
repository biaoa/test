...
public class WinphoneNotification extends PlatformNotificationjpush {
    ...
    public static class Builder extends PlatformNotificationjpush.Builder<WinphoneNotification, Builder> {
