...
public class ExportExcel<T> {
   ...
   /* public void exportExcel(Collection<T> dataset, OutputStream out) {
    ...
    public void exportExcel(HSSFWorkbook workbook,int sheetNum,String title,String[] headers, Collection<T> dataset,
            OutputStream out) {
        exportExcel(workbook,sheetNum,title, headers, dataset, out, "yyyy-MM-dd");
    }
    ...
    public void exportExcel(HSSFWorkbook workbook,int sheetNum,String title, String[] headers,
